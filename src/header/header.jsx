...
export default function Header() {
  return (
    <div className="overflow-hidden font-iranSansMed">
      <Nav />
      <div className="relative h-auto w-screen bg-[url('/src/public/images/hero-bg.jpg')] from-slate-500 to-slate-500 bg-cover bg-top bg-no-repeat py-14 before:absolute before:bottom-0 before:left-0 before:right-0 before:top-0 before:bg-[rgba(0,0,0,.6)] md:h-[91vh] md:bg-center">
